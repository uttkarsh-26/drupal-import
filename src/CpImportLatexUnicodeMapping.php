...
/**
 * Class CpImportLatexUnicodeMapping.
 *
 * @package Drupal\cp_import
 */
final class CpImportLatexUnicodeMapping {
  ...
  public function getSearchPatterns() {
    $searchStrings = array_keys(self::LATEX_UNICODE);
  ...
  public function getReplaceStrings() {
    return array_values(self::LATEX_UNICODE);
  }
